...
const commands = (bot, msg, cmd, subcmd) => {
  ...
  if (_set.channelPerm !== undefined && currChannel !== `${_set.channelPerm}`) {
    ...
    if (cmd === 'help') (0, _help2.default)(bot, msg, cmd);else if (cmd === 'invites') (0, _invitesCalc2.default)(bot, msg, cmd);else if (cmd === 'top' && subcmd) (0, _top2.default)(bot, msg, cmd, subcmd);else if (cmd === 'membercount') (0, _membercount2.default)(msg);else if (cmd === 'set') (0, _set2.default)(msg, cmd, subcmd);else return;
  }
};
